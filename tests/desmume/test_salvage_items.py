...
from tests.desmume.desmume_utils import DesmumeEmulator, start_first_file
...
def salvage_item_test_emu(tmp_path: Path, desmume_emulator: DesmumeEmulator, request):
...
def test_custom_salvage_items(salvage_item_test_emu: DesmumeEmulator):
    ...
    salvage_item_test_emu.emu.input.touch_set_pos(207, 90)
    salvage_item_test_emu.wait(2)
    salvage_item_test_emu.emu.input.touch_set_pos(220, 90)
    salvage_item_test_emu.wait(2)
    salvage_item_test_emu.emu.input.touch_release()
    salvage_item_test_emu.wait(2)

    # Click "Go!" button
    salvage_item_test_emu.emu.input.touch_set_pos(90, 130)
    salvage_item_test_emu.wait(2)
    salvage_item_test_emu.emu.input.touch_release()
    ...
    salvage_item_test_emu.emu.input.touch_set_pos(0, SCREEN_HEIGHT)
    salvage_item_test_emu.wait(10)
    salvage_item_test_emu.emu.input.touch_release()
    salvage_item_test_emu.wait(10)
    salvage_item_test_emu.emu.input.touch_set_pos(195, 175)
    salvage_item_test_emu.wait(10)
    salvage_item_test_emu.emu.input.touch_release()
    ...
    salvage_item_test_emu.emu.memory.unsigned[0x021F56E0] = 0xFF

    # Pull salvage icon down until we get to the chest
    salvage_item_test_emu.emu.input.touch_set_pos(125, 170)
    salvage_item_test_emu.wait(10)
    salvage_item_test_emu.emu.input.touch_set_pos(125, 190)
    ...
    salvage_item_test_emu.emu.input.touch_set_pos(125, 170)
    salvage_item_test_emu.wait(10)
    salvage_item_test_emu.emu.input.touch_set_pos(125, 130)
    ...
    original_value = salvage_item_test_emu.emu.memory.unsigned[ITEM_MEMORY_ADDRESSES[item_id][0]]
    if ITEM_MEMORY_ADDRESSES[item_id][2] == ItemMemoryAddressType.FLAG:
        ...
        original_value = salvage_item_test_emu.emu.memory.unsigned[
        ...
        original_value = int.from_bytes(
            salvage_item_test_emu.emu.memory.unsigned[
    ...
    salvage_item_test_emu.wait(200)
    salvage_item_test_emu.emu.input.touch_set_pos(0, 0)
    salvage_item_test_emu.wait(2)
    salvage_item_test_emu.emu.input.touch_release()
    salvage_item_test_emu.wait(200)
    salvage_item_test_emu.emu.input.touch_set_pos(0, 0)
    ...
    if ITEM_MEMORY_ADDRESSES[item_id][2] == ItemMemoryAddressType.FLAG:
        assert (
            salvage_item_test_emu.emu.memory.unsigned[ITEM_MEMORY_ADDRESSES[item_id][0]]
