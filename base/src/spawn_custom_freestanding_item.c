 ...
 */
uint16_t spawn_freestanding_item(void *param_1, uint32_t npc_type, void *param_3, uint16_t *param_4) {
    ...
    // otherwise, spawn one of our custom RUPY NPCs with the appropriate item id
    *param_4 = item_id; // set rupy_type to the item_id (see `extend_RUPY_npc.c` to see how this value is used)
